...
#if UNITY_EDITOR
public class EditorEnemyPaths : EditorWindow
{
    public string paramTest_string;
    public EnemyPathData OutPut_Path;
    public float TimeBetweeenPoints;
    ...
    //////////Param for Spawn and Middel Points///////////
    ...
    void CreateLevel()
    {
        OutPut_Path = ScriptableObject.CreateInstance<EnemyPathData>();
    }
    ...
    {
        var window = GetWindow<EditorEnemyPaths>("PathEditor");
        window.Show();
    }
    ...
    public void SettingInOutParameters()
    {
        paramTest_string = EditorGUILayout.TextField(
            "File Name", 
            paramTest_string);
        OutPut_Path = EditorGUILayout.ObjectField(
            "Output File", 
            OutPut_Path, typeof(EnemyPathData), true) as EnemyPathData;
        TimeBetweeenPoints = EditorGUILayout.FloatField(
            "Time Each Path", 
            TimeBetweeenPoints);
    ...
    private void OnGUI() 
    {
        ...
        if(GUILayout.Button("Confirm Setting Path to export file") && OutPut_Path != null)
        {         
            ...
            OutPut_Path.firstPoint = _spawnPoints;
            OutPut_Path.middlePointIndex = _middlePoints;
            OutPut_Path.time = TimeBetweeenPoints;

            string path = "Assets/Resources/EnemiesPaths/" + paramTest_string + ".asset";
            try
            {
                AssetDatabase.CreateAsset(OutPut_Path, path);
                paramTest_string = "";
                CreateLevel();
                ResetArgument();
    ...
    public void drawBySerial(UnityEngine.Object obj)
    {
        ...
        SerializedProperty sp1 = test.FindProperty("spawnPoints");
        SerializedProperty sp2 = test.FindProperty("middlePoints");
